...
<link rel="stylesheet" href="style_sheets/styles3.css">
...
@section('menu')
    ...
    <u><b>Цікаві статті</b></u>&emsp;&emsp;
    ...
    <div class="part2">
        ...
        <div class="flexbox">
            ...
            <div class="product1">
                ...
                <img class="image" src="images/kuwait_fire1.jpg" alt="">
                <hr class="image_line">

                <h2 class="header">Пожежа на сміттєзвалищі в Кувейті</h2>
                <p class="text">У Кувейті горить найбільше у світі звалище автомобільних шин, повідомляють місцеві ЗМІ.
                    Очевидці публікують фотографії та відео пожежі та зазначають, що гігантський стовп диму видно здалеку...
                </p>
                <p class="price">Джерело: <a href="https://motor.ru/news/video-of-thick-black-smoke-04-08-2021.htm">Motor News</a></p>

                <a href="article1"><button class="buy">Читати</button></a>
            </div>

            <div class="product2">

                <img class="image" src="images/stop_plastic1.jpg" alt="">
                <hr class="image_line">

                <h2 class="header">Заборона пластику в Україні</h2>
                <p class="text">Закон спрямований на зменшення обсягу використання в Україні пластикових пакетів, обмеження їх розповсюдження
                    з метою поліпшення стану навколишнього природного середовища та благоустрою територій. Дана заборона не поширюється на...</p>
                ...
                obihu-plastykovykh-paketiv-na-terytorii-ukrainy"><button class="buy">Читати</button></a>
        ...
        <div class="flexbox">
            ...
            <div class="product3">
                ...
                <h2 class="header">2021 - cеред найспекотніших років</h2>
                <p class="text">Планета пережила черговий рекордно спекотний рік, кажуть вчені та попереджають, що разом із температурою
                    збільшується і концентрація парникових газів - головної причини глобального потепління, спричиненого людиною...
                </p>
                ...
                83%201850%2D1900%20%D1%80%D0%BE%D0%BA%D0%B0%D1%85.&text=Getty%20Images-,%D0%9F%D1%96%D0%B4%D0%BF%D0%B8%D1%81%20%D0%B4%D0%
                BE%20%D1%84%D0%BE%D1%82%D0%BE%2C,15%20%D1%80%D0%BE%D0%BA%D1%96%D0%B2%20%2D%205%20%D1%82%D1%80%D0%BB%D0%BD%20%D1%82%D0%BE%
                D0%BD%D0%BD."><button class="buy">Читати</button></a>
            </div>
            ...
            <div class="product4">
                ...
                <h2 class="header">Життя на сміттєвій плямі</h2>
                ...
                <a href="https://www.sciencealert.com/plants-and-animals-have-started-living-on-the-great-pacific-garbage-patch"><button class="buy">Читати</button></a>
